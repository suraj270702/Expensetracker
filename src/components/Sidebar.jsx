            ...
            <div className="w-full h-full md:w-[1050px] md:h-[650px] bg-[#FFF] rounded-[20px] shadow-sm p-4 md:p-6">
              <div>
                <div className="flex flex-col md:flex-row md:gap-x-4 gap-y-4 md:gap-y-0">
                  <div className="md:w-[500px]  h-full w-full rounded-[10px] shadow-sm bg-[#FDF7FF] p-4 md:p-8">
                    <div>
                      ...
                      <button onClick={()=>dispatch(increment({name:"suraj"}))} className="text-20px md:text-[30px] text-[#fff] px-6 py-2 bg-[#845EC2] rounded-[10px] hover:bg-[#935af0] transition ease-in-out duration-300 font-[600] mt-6 w-full">
                        {" "}
                        Add
                      </button>
                    </div>
                  ...
                  <div className="md:w-[500px]  h-full w-full rounded-[10px] shadow-sm bg-[#FDF7FF] p-4 md:p-8">
                    <div>
                      ...
                      <button className="text-20px md:text-[30px] text-[#fff] px-6 py-2 bg-[#845EC2] rounded-[10px] hover:bg-[#935af0] transition ease-in-out duration-300 font-[600] mt-6 w-full">
                        Update
                      </button>
                    </div>
                  </div>
                ...
                <div className="w-full h-full md:w-[1000px] shadow-sm bg-[#FDF7FF] p-4 md:p-8 mt-4 rounded-[10px] ">
                  ...
                  <button className="text-20px md:text-[30px] text-[#fff] px-6 py-2 bg-[#845EC2] rounded-[10px] hover:bg-[#935af0] transition ease-in-out duration-300 font-[600] mt-4 w-full">
                        Add Expense
                      </button>
                </div>
              </div>
