    ...
    <>
      <div className="flex flex-col md:flex-row">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row">
            <div className="w-full h-full md:w-[1050px] md:h-[585px] bg-[#FFF] rounded-[20px] shadow-sm"></div>
            <div className=" md:row-span-2 bg-[#FFF] shadow-sm rounded-[10px] min-h-[585px]"></div>
          </div>
        </div>
      </div>
    </>
